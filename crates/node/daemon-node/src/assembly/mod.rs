...
fn build_orchestrator_profile(
    ...
    let mut registry = core_tool_registry_with_skills(&a.extra_tools, launch_skill_tools, procs);
...
fn build_session_profile(
    ...
    let mut session_registry =
        core_tool_registry_with_skills(&a.extra_tools, launch_skill_tools, procs);
