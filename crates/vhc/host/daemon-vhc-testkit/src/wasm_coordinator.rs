...
//! Re-export of the production wasm-coordinator drive (`daemon_vhc_host::wasm_coordinator`).
//!
//! The configuration seat + in-process drive were LIFTED out of this harness into the host crate
//! when the worker's self-driven join re-seated onto the wasm coordinator: the ratified rule is
...
//! testkit-facing paths (`daemon_vhc_testkit::wasm_coordinator::*`, the crate-root re-exports)
//! are unchanged.
