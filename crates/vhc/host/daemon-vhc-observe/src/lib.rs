...
pub use journal::{
    ...
    replay_consensus_from_verified_archive, scan_bytes, semantic_fold, verify_chains,
    verify_committed_payloads, ArchiveError, AssembleError, AssembleReport, AttestedHead, Body,
    ChainHead, ConsensusCapture, ConsensusReplayError, ConsensusReplayReport, ExecIdentity,
    ForkEvidence, Journal, JournalError, JournalPaths, Record, RecordArchive, RecoveredChain,
    ReplicationPolicy, RetentionPolicy, RotatePolicy, SemanticFold, SemanticFoldError,
    SidecarError, VerifiedChain, WireCapture, WireFrame, WirePublish,
};
