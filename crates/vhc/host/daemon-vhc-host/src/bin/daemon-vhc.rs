...
//! The `daemon-vhc-host` worker binary.
//!
//! Wave-0 scaffold: prints a version line so the supervisor client (`daemon-vhc-supervisor`) has a
...
fn main() {
    ...
    println!(
        "daemon-vhc {} (tensor-abi {}.{})",
        env!("CARGO_PKG_VERSION"),
        daemon_vhc_host::TENSOR_ABI_VERSION >> 16,
        daemon_vhc_host::TENSOR_ABI_VERSION & 0xffff,
    );
}
