...
//!
//! The shared types are re-exported from [`daemon_vhc_net::seam`], which (as of Merge 1) resolves
//! them to the canonical [`daemon_vhc_proto`] types — the content hash is proto's blake3 `Hash`
...
pub use daemon_vhc_net::seam::{ContentHash, PayloadKey, PeerId, RoundId, RunId};
