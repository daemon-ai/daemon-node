...
//! [`daemon_vhc_sdk::models::TinyLlama`] (architecture §10.5), so the wasm guest and the SDK's sim
...
use daemon_vhc_sdk::models::TinyLlama;
use daemon_vhc_sdk::Experiment;

daemon_vhc_sdk::experiment!(TinyLlama);
