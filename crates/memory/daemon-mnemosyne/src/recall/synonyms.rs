...
const STOP_WORDS: &[&str] = &[
    ...
    "after", "above", "below", "between", "under", "and", "but", "or", "nor", "not", "so", "than",
    "too", "very", "just", "about", "also", "really", "actually", "basically", "simply", "if",
    "then", "else", "while", "because", "though", "although",
];
...
mod tests {
    ...
    fn normalizes_to_canonical_sorted() {
        ...
        assert_eq!(normalize_query("what is the db password"), "database password");
    }
