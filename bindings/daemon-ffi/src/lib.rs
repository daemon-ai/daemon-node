...
mod wire_fixtures {
    ...
    /// "hi", attachments: [], notice: null }, request_id: 1 }, origin: null, profile: null }`.
    /// `notice` is the wire-v29 completion-notice provenance field on `UserMsg`
    /// (`#[serde(default)]`, always encoded).
